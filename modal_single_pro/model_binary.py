...
train_dataset = EmbeddingPairDataset(train_df, pro_embed_dict)
val_dataset = EmbeddingPairDataset(val_df, pro_embed_dict)
...
model = SingleModalClassifier(pro_dim).to(device)
