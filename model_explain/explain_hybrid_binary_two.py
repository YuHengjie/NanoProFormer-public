...
# %%
keys_to_keep = ['Accuracy', 'Precision', 'Recall', 'F1 score', 'AUC score']
metrics_save = {key: metrics[key] for key in keys_to_keep if key in metrics}

with open('explain_hybrid_binary_two_baseline.json', 'w') as f:
...
# %%
f1_result_df.to_csv('hybrid_binary_two.csv',)
