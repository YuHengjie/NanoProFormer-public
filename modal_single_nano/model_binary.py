...
train_dataset = EmbeddingPairDataset(train_df, x_embed_data_fill, x_embed_data_non_fill, )
val_dataset = EmbeddingPairDataset(val_df, x_embed_data_fill, x_embed_data_non_fill, )
...
model = SingleModalClassifier(x_dim,).to(device)
