...
# %%
test_df = pd.read_csv("test_data_reg.csv",keep_default_na=False, na_values=[''])
test_df

# %%
class EmbeddingPairDataset_reg(Dataset):
...
test_dataset = EmbeddingPairDataset_reg(test_df, x_embed_data, pro_embed_dict)
