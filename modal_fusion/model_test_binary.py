...
# %%
test_df = pd.read_csv("test_data_binary.csv",keep_default_na=False, na_values=[''])
test_df

# %%
class EmbeddingPairDataset_binary(Dataset):
...
test_dataset = EmbeddingPairDataset_binary(test_df, x_embed_data, pro_embed_dict)
